module github.com/last9/go-agent
...
require (
	...
	github.com/testcontainers/testcontainers-go v0.31.0 // test only
	github.com/testcontainers/testcontainers-go/modules/kafka v0.31.0 // test only
	github.com/testcontainers/testcontainers-go/modules/postgres v0.31.0 // test only
	github.com/testcontainers/testcontainers-go/modules/redis v0.31.0 // test only
)
