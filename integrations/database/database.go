...
//
// This is useful when you create manual wrapper spans for DB operations and want
// to stamp them with connection attributes (server.address, server.port, db.user).
// Without this, those attributes only appear on spans auto-generated by otelsql.
//
...
//
// Example usage with a manual span:
//
...
func ParseDSNAttributes(dsn, driverName string) []attribute.KeyValue {
...
func Open(cfg Config) (*sql.DB, error) {
	...
	dsnAttrs := ParseDSNAttributes(cfg.DSN, cfg.DriverName)
